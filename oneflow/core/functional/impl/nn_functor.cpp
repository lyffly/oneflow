...
class EmbeddingLookupFunctor {
 public:
  ...
  Maybe<Tensor> operator()(const std::shared_ptr<one::Tensor>& var,const std::shared_ptr<one::Tensor>& ids,
    ...
    return OpInterpUtil::Dispatch<Tensor>(*op_, {var, ids, column_ids}, attrs);
  }
